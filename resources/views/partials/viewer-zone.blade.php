{{-- İzleyici Bölgesi: Kayıt, görevler, izleme süresi, sosyal paylaşım --}}
<section id="viewer-zone" class="section-sura py-16 sm:py-24 px-6 relative bg-dark-800/50">
    <div class="max-w-5xl mx-auto">
        <span class="section-voice-label text-amethyst-200/90 text-xs font-mono tracking-widest uppercase block mb-2 reveal">İzleyiciler</span>
        <h2 class="section-title-wraith text-2xl sm:text-3xl font-cinzel font-bold text-parchment-100 mb-2 reveal">
            İzleyici Bölgesi
        </h2>
        <p class="text-parchment-400 text-sm mb-10 reveal">İzle, görev tamamla, XP kazan. En uzun süre izleyen rozeti senin olabilir!</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 reveal">
                <div class="viewer-profile-card rounded-2xl p-6 border border-amethyst-100/15 bg-amethyst-300/5" id="viewer-card">
                    ...
                    {{-- Registered state (hidden by default) --}}
            ...
            <div class="lg:col-span-2 space-y-6 reveal">
                {{-- Social Share (kanıt fotoğrafı ile talep, şura onayı) --}}
                <div class="rounded-2xl p-6 border border-white/10 bg-white/[0.03]">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3" id="social-share-btns">
                        <button type="button" class="social-share-btn flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-blue-400/20 bg-blue-500/10 text-blue-400 text-sm hover:bg-blue-500/20 transition-colors" data-platform="twitter" data-points="15">
                            𝕏 <span class="text-xs">+15 XP</span>
                        </button>
                        <button type="button" class="social-share-btn flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-pink-400/20 bg-pink-500/10 text-pink-400 text-sm hover:bg-pink-500/20 transition-colors" data-platform="instagram" data-points="20">
                            📷 <span class="text-xs">+20 XP</span>
                        </button>
                        <button type="button" class="social-share-btn flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-blue-600/20 bg-blue-700/10 text-blue-300 text-sm hover:bg-blue-700/20 transition-colors" data-platform="linkedin" data-points="25">
                            💼 <span class="text-xs">+25 XP</span>
                        </button>
                        <button type="button" class="social-share-btn flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-white/10 bg-white/5 text-parchment-200 text-sm hover:bg-white/10 transition-colors" data-platform="tiktok" data-points="20">
                            🎵 <span class="text-xs">+20 XP</span>
                        </button>
                    </div>
                </div>

                {{-- XP talep modalı: kanıt fotoğrafı yükle --}}
                ...
                {{-- İzleyici sıralaması (canlı güncellenir) --}}
                <div class="rounded-2xl p-6 border border-white/10 bg-white/[0.03]">
