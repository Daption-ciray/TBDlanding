...
>
    <div class="max-w-5xl mx-auto text-center">
        ...
        <p class="text-parchment-400 text-sm mb-12 reveal">
            <strong class="text-gold-200">Uyanış</strong> · <strong class="text-gold-300">Kurgu</strong> · <strong class="text-red-400">Optimizasyon</strong> · <strong class="text-gold-100">Kaynak Kod</strong>
        </p>
