...
>
    <div class="max-w-5xl mx-auto">
        ...
        <p class="text-parchment-400 text-sm mb-12 reveal">
            <strong class="text-gold-200">Genesis</strong> · <strong class="text-gold-300">Vahiy</strong> · <strong class="text-red-400">İmtihan</strong> · <strong class="text-gold-100">Kıyamet</strong>
        </p>
