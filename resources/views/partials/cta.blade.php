...
<section class="py-16 px-6 text-center border-t border-white/10 {{ $activeRole === 'mimar' ? 'bg-[#020617] mimar-theme' : 'bg-dark-900 kasif-theme' }}">
    <div class="max-w-xl mx-auto reveal">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-3 mb-12">
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfYOdCxVnMWK7nBQBdlQE9d7JX_wfy2vOuo_bLmm7SSY4w6yg/viewform" target="_blank" class="btn-wraith-cta inline-flex items-center justify-center px-10 py-4 rounded-lg text-sm font-semibold text-black {{ $activeRole === 'mimar' ? 'bg-amethyst-300 hover:bg-amethyst-200' : 'bg-gold-200 hover:bg-gold-100' }} transition-all">
