...
<section
    id="hero"
    class="hero-wraith min-h-[90vh] flex flex-col justify-center relative overflow-hidden {{ $activeRole === 'mimar' ? 'hero-theme-mimar' : 'hero-theme-kasif' }}"
    ...
    <div class="relative z-10 px-6 py-20 max-w-4xl mx-auto text-center">
        ...
        <div class="mb-4 reveal flex flex-col items-center">
            ...
            <div class="w-48 h-1 bg-white/5 rounded-full overflow-hidden border border-white/5">
                <div class="h-full {{ $activeRole === 'mimar' ? 'bg-amethyst-300 shadow-[0_0_10px_rgba(168,85,247,0.5)]' : 'bg-gold-200 shadow-[0_0_10px_rgba(250,204,21,0.5)]' }} transition-all duration-1000 ease-out" style="width: {{ $syncPercent ?? 0 }}%"></div>
            </div>
