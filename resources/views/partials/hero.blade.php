...
>
    ...
    <div class="relative z-10 px-6 py-20 max-w-4xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4 reveal">
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfYOdCxVnMWK7nBQBdlQE9d7JX_wfy2vOuo_bLmm7SSY4w6yg/viewform?usp=header" target="_blank" class="btn-wraith-cta inline-flex items-center justify-center px-10 py-4 rounded-lg text-sm font-semibold text-black {{ $activeRole === 'mimar' ? 'bg-amethyst-300 hover:bg-amethyst-200' : 'bg-gold-200 hover:bg-gold-100' }} transition-all">
                Takımla Başvur
            </a>
